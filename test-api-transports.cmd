...
cl /nologo /std:c++20 /EHsc /W4 /WX /Zi /Od /Fo"%ROOT%build\dx11_transport_integration.obj" /Fe"%ROOT%build\dx11_transport_integration.exe" "%ROOT%tests\dx11_transport_integration.cpp" /link d3d11.lib d3d12.lib dxgi.lib || exit /b 1
